...
var addUser = function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    ...
    return __generator(this, function (_c) {
        return [2 /*return*/, (__assign(__assign({}, data), { user: req.user.id }))];
    });
}); };
var stripeOp = function (args) { return __awaiter(void 0, void 0, void 0, function () {
    var data, createdProduct, finalProduct, updatedProduct, finalProduct;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                finalProduct = __assign(__assign({}, data), { stripeId: createdProduct.id, priceId: createdProduct.default_price });
                return [2 /*return*/, finalProduct];
            case 2:
                if (!(args.operation === "update")) return [3 /*break*/, 4];
                return [4 /*yield*/, stripe_1.stripe.products.update(data.stripeId, { name: data.name, default_price: data.priceId })];
            case 3:
                updatedProduct = _a.sent();
                finalProduct = __assign(__assign({}, data), { stripeId: updatedProduct.id, priceId: updatedProduct.default_price });
                return [2 /*return*/, finalProduct];
...
var syncUser = function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4 /*yield*/, req.payload.findByID({ collection: "users", id: req.user.id })];
            case 1:
                fullUser = _c.sent();
                ...
                return [4 /*yield*/, req.payload.update({ collection: "users", id: fullUser.id, data: { products: dataToUpdate } })];
            case 2:
                _c.sent();
                _c.label = 3;
...
exports.Products = {
    ...
    fields: [
        ...
        },
        {
            ...
            label: "Category",
            type: "select",
            options: productCategories_1.PRODUCT_CATEGORIES.map(function (_a) {
