            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, payload_utils_1.isAdminOrHasAccessToImages)()({ req: req })];
                    case 1: return [2 /*return*/, _c.sent()];
                }
            });
        }); },
        delete: (0, payload_utils_1.isAdminOrHasAccessToImages)(),
        update: (0, payload_utils_1.isAdminOrHasAccessToImages)()
    },
    admin: {
        hidden: function (_a) {
            var user = _a.user;
