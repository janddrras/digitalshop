...
var stripeWebhookHandler = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                payload = _c.sent();
                return [4 /*yield*/, payload.find({ collection: "users", where: { id: { equals: session.metadata.userId } } })];
            case 2:
                users = (_c.sent()).docs;
                user = users[0];
                if (!user)
                    return [2 /*return*/, res.status(404).json({ error: "No such user exists." })];
                return [4 /*yield*/, payload.find({ collection: "orders", depth: 2, where: { id: { equals: session.metadata.orderId } } })];
            case 3:
                orders = (_c.sent()).docs;
                order = orders[0];
                if (!order)
